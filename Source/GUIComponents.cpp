...
GUIComponents::GUIComponents ()
{
	...
	textButtonDisconnect->setEnabled(false);
    //[/UserPreSize]
...
{
    textEditorNameserver->setBounds (160, 24, 150, 24);
    textButton->setBounds (328, 24, 96, 24);
    label->setBounds (16, 64, 128, 24);
    label2->setBounds (16, 24, 150, 24);
    textEditorPort->setBounds (160, 64, 150, 24);
    textEditorOutput->setBounds (160, 112, 280, 232);
    textButtonDisconnect->setBounds (328, 64, 96, 24);
    label3->setBounds (16, 112, 128, 24);
...
void GUIComponents::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    if (buttonThatWasClicked == textButton)
    {
		...
		if (myYarpInterface->setPortName(portstr)) {
			...
			textButtonDisconnect->setEnabled(true);
...
<JUCER_COMPONENT documentType="Component" className="GUIComponents" componentName=""
  ...
  <TEXTEDITOR name="new text editor" id="b264509ac6d8f3c9" memberName="textEditorNameserver"
              virtualName="" explicitFocusOrder="0" pos="160 24 150 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <TEXTBUTTON name="new button" id="5f342e7982e34039" memberName="textButton"
              virtualName="" explicitFocusOrder="0" pos="328 24 96 24" buttonText="connect"
  ...
  <TEXTEDITOR name="new text editor" id="2921870cfbe547c3" memberName="textEditorPort"
              virtualName="" explicitFocusOrder="0" pos="160 64 150 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <TEXTEDITOR name="new text editor" id="2d5482ce1491c10f" memberName="textEditorOutput"
              virtualName="" explicitFocusOrder="0" pos="160 112 280 232" initialText=""
              multiline="1" retKeyStartsLine="1" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <TEXTBUTTON name="new button" id="84cae9a3ed16fc8d" memberName="textButtonDisconnect"
              virtualName="" explicitFocusOrder="0" pos="328 64 96 24" buttonText="disconnect"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <LABEL name="new label" id="605ff976507302cc" memberName="label3" virtualName=""
         explicitFocusOrder="0" pos="16 112 128 24" edTextCol="ff000000"
